...
//            "network" : {
//               "addresses" : [
//                  "2001:470:7ca1:ff80:32b5:c2ff:fec6:b578",
//                  "fe80:0:0:0:32b5:c2ff:fec6:b578",
//                  "fdef:ffc0:4fff:0:32b5:c2ff:fec6:b578"
//               ],
...
row.netaddrc = row.netaddr.length;
        ...
        //        row.netaddr = ni.network.addresses.sort();
...
row.trarxu = ~~(row.trarx / row.uptime);
row.tratxu = ~~(row.tratx / row.uptime);
row.traforu = ~~(row.trafor / row.uptime);

row.tramgum = ~~((row.tramgrxu+row.tramgtxu)*3600*24*30/1000/1000);
row.traum = ~~((row.trarxu+row.tratxu+row.traforu)*3600*24*30/1000/1000);

row.trassn = (row.traum/(row.traum+row.tramgum+0.000001))

row.tramgrxum = ~~((row.tramgrxu)*3600*24*30/1000/1000);
row.tramgtxum = ~~((row.tramgtxu)*3600*24*30/1000/1000);
row.trarxum = ~~((row.trarxu)*3600*24*30/1000/1000);
row.tratxum = ~~((row.tratxu)*3600*24*30/1000/1000);
row.traforum = ~~((row.traforu)*3600*24*30/1000/1000);
...
var cols = [
	{ resizable: true, sortable: true, field: 'isOnline'    , caption: 'Online'      , size: '20px', render: renderBool, style: 'text-align: center;', hidden: false},
	{ resizable: true, sortable: true, field: 'isGateway'   , caption: 'GW'     , size: '20px', render: renderBool, style: 'text-align: center;', hidden: false},
	{ resizable: true, sortable: true, field: 'hasVpn'      , caption: 'VPN'        , size: '20px', render: renderBool, style: 'text-align: center;'},
	{ resizable: true, sortable: true, field: 'hasNeighbour', caption: 'Link'       , size: '20px', render: renderBool, style: 'text-align: center;', hidden: false},
	{ resizable: true, sortable: true, field: 'vpnCnt'      , caption: 'Vs'        , size: '20px', style: 'text-align: right;', hidden: false},
	{ resizable: true, sortable: true, field: 'neighbourCnt', caption: 'Ls'       , size: '20px', style: 'text-align: right;'},
        { resizable: true, sortable: true, field: 'clients'     , caption: 'Cs'     , size: '20px', style: 'text-align: right;'},
	{ resizable: true, sortable: true, field: 'id'          , caption: 'Node ID'     , size: '100px', style: 'font-family: monospace;'},
	{ resizable: true, sortable: true, field: 'hostname'    , caption: 'Hostname'    , size: '140px'},
	{ resizable: true, sortable: true, field: 'owner'       , caption: 'Owner'       , size: '100px'},
//	{ resizable: true, sortable: true, field: 'version'     , caption: 'Gluon Vers.' , size: '150px'},
	{ resizable: true, sortable: true, field: 'model'       , caption: 'HW model'    , size: '140px'},
...
//	{ resizable: true, sortable: true, field: 'gateway'     , caption: 'Gateway'     , size: '110px', style: 'text-align: right;'},
	{ resizable: true, sortable: true, field: 'site'        , caption: 'Site'        , size: '100px', style: 'text-align: right;'},
	{ resizable: true, sortable: true, field: 'uptime'      , caption: 'Uptime'      , size: '70px', style: 'text-align: right;'},
...
//	{ resizable: true, sortable: true, field: 'memoryUsage' , caption: '\%Mem'       , size: '60px', render: renderPercent, style: 'text-align: right; position: relative;'},
...
//        { resizable: true, sortable: true, field: 'netaddr'       , caption: 'Addresses'    , size: '700px'},
//        { resizable: true, sortable: true, field: 'netaddrc'      , caption: 'Addr\#'        , size: '50px', style: 'text-align: right;', hidden: false},
...
//        { resizable: true, sortable: true, field: 'tratx'       , caption: 'TXBytes'    , size: '100px', style: 'text-align: right;'},
        { resizable: true, sortable: true, field: 'tramgrxum'       , caption: 'mR[MBpM]'    , size: '60px', style: 'text-align: right;'},
        { resizable: true, sortable: true, field: 'tramgtxum'       , caption: 'mT[MBpM]'    , size: '60px', style: 'text-align: right;'},
        { resizable: true, sortable: true, field: 'trarxum'       , caption: 'R[MBpM]'    , size: '60px', style: 'text-align: right;'},
        { resizable: true, sortable: true, field: 'tratxum'       , caption: 'T[MBpM]'    , size: '60px', style: 'text-align: right;'},
        { resizable: true, sortable: true, field: 'traforum'       , caption: 'F[MBpM]'    , size: '60px', style: 'text-align: right;'},
//        { resizable: true, sortable: true, field: 'tramgtxu'       , caption: 'MgmtTXBpU'    , size: '100px', style: 'text-align: right;'},

        { resizable: true, sortable: true, field: 'tramgum'       , caption: 'mRT[MBpM]'    , size: '60px', style: 'text-align: right;'},
        { resizable: true, sortable: true, field: 'traum'       , caption: 'RTF[MBpM]'    , size: '60px', style: 'text-align: right;'},

        { resizable: true, sortable: true, field: 'trassn'       , caption: 'eta'    , size: '50px', style: 'text-align: right;'},
...
$('#grid').w2grid({
	name: 'grid',
	header: document.title = '::: ' + nodelistconfig.siteName,
	show: {
		header:        true,
		toolbar:       true,
		toolbarReload: false,
...
//		{field: 'gateway'     , caption: 'Gateway'       , type: 'enum', options: {items: Object.keys(enums.gateways)}},
		...
		{field: 'uptime'      , caption: 'Uptime'        , type: 'int'},
...
//                window.open(nodelistconfig.graphPath + 'node?var-node_id=' + records[event.recid].id, '_blank');
//                window.open(nodelistconfig.graphPath + 'node-graphite?var-node_id=' + records[event.recid].id, '_blank');
	},
});
